...
import { getBookResource } from '../services/bookServices'
import BookCoversCarousel from './BookCoversCarousel'
import { cleanDescription } from '../utils/bookUtils'

function BookDetail() {
    // Extraer el id de la url
    const params = useParams()
    
  const bookData = use(getBookResource(params.id))
  return (
  <div className="max-w-4xl mx-auto p-6">
    ...
    <div className="mb-8">
      ...
      <p className="text-gray-600 leading-relaxed bg-gray-50 p-4 rounded-lg">
        {/* bookData.description puede ser string u objeto */}
        {cleanDescription(bookData.description)}
      </p>
    </div>
